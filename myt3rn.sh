...
function execute_script() {
    # 下载文件
    if [ -f "executor-linux-v0.24.1.tar.gz" ]; then
        echo "文件 executor-linux-v0.24.1.tar.gz 已存在，跳过下载。"
    else
        echo "正在下载 executor-linux-v0.24.1.tar.gz..."
    ...
    # 删除压缩文件
    echo "删除压缩包..."
    rm executor-linux-v0.24.1.tar.gz
